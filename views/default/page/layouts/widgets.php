...
if (elgg_in_context("videos") || elgg_in_context("nieuws")) {
	$widget_content = "";
	...
	$vars["content"] = "<div id='elgg-widget-col-4' class='elgg-widgets'>" . $widget_content . "</div>";
	...
	$style = "#elgg-widget-col-4 { width: 66%;" . $min_height . "float: left;}";
